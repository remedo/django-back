...
class Prescription(models.Model):
    ...
    patient_id =  models.ForeignKey(Patient, on_delete=models.CASCADE,to_field="patient_id" )
    doctor_id=  models.ForeignKey(Doctor, on_delete=models.CASCADE,to_field="doctor_id")
